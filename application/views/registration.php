		...
		<!--Start Header-->
			...
			<div data-role="content" id="main-content">
				...
				<?php echo form_open('user'); ?>
					...
					<input type="password" name="reg_pass" id="reg_pass" value="" placeholder="Password"/>
					<input type="password" name="reg_pass_confirm" id="reg_pass_confirm" value="" placeholder="Confirm Password"/>
