...
# Database: challenge
# Generation Time: 2013-02-20 16:08:04 +0000
# ************************************************************
...
CREATE TABLE `challenges` (
  ...
  CONSTRAINT `challenges_ibfk_1` FOREIGN KEY (`challenge_id`) REFERENCES `challenge_comments` (`challenge_id`),
  CONSTRAINT `challenges_ibfk_2` FOREIGN KEY (`challenge_id`) REFERENCES `challenge_type` (`challenge_id`),
...
VALUES
	(1,NULL,'seean','casey','seancasey08@gmail.com','skapunk456'),
	(2,NULL,'casey','casey','seancasey09@gmail.com','skapunk456');
